# ⬡ ChemoFilter: Ethical AI & Pharmacology Safety Policy

**Human-in-the-Loop Philosophy for AI-Driven Drug Discovery**  
*Strategic Prevention of AI Hallucinations in Clinical Triage*

---

## 1. Executive Overview

Large Language Models (LLMs) like Anthropic Claude 3 or Google Gemini can sometimes "hallucinate" scientific facts. In the context of drug discovery, a hallucination could lead to a toxic compound being incorrectly labeled as safe. 

**ChemoFilter** addresses this by using a **"Strictly Scientific Anchor"** approach in `ai_explainer_tab.py`.
