...
def check_structural_integrity(mol):
    ...
    # Unusual Valence - use GetTotalValence (non-deprecated)
    unusual_val = False
    ...
    for a in mol.GetAtoms():
        ...
        try:
            ...
            v = 0
        if s in typical and v not in typical[s]:
            unusual_val = True

    # Chiral centers - use FindPotentialStereo for newer rdkit compat
    try:
...
# Generate chain/ring variations
for i in range(2, 51):
